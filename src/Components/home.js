...
function Home({ setProgress, userLogin }) {
  ...
  const handleedits = async (evt) => {
    ...
    await fetch(
      "https://e-notebook-backend-production.up.railway.app/api/editingnote",
      {
        method: "POST",
        headers: {
  ...
  const handledelete = async (evt) => {
    ...
    await fetch(
      "https://e-notebook-backend-production.up.railway.app/api/deletingnote",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchallnotes = async () => {
    ...
    try {
      const response = await fetch(
        "https://e-notebook-backend-production.up.railway.app/api/fetchnote",
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <>
      {data.length <= 0 && email === "" ? (
        ...
        >
          <h3>
            This is your Digital Notebook Where you can save all your
            information and notes safely
          </h3>
          <h5
            style={{
              width: "28vw",
